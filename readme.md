...
A Computer Vision tool capable of automatically detecting and removing watermarks from IMGs and videos. This project utilizes a hybrid AI pipeline, combining YOLOv8 for object detection and OpenCV/Inpainting for automated restoration.
